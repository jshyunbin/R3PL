"""
TRM PyTorch Lightning Module - Following Figure 2 pseudocode exactly
"""
...
class TRMModule(LightningModule):
    ...
    def __init__(
        ...
        log.info(f"Creating TRM with vocab size={vocab_size}, {seq_len=}, {puzzle_emb_len=} {pos_emb_type=} {puzzle_emb_dim=}")
