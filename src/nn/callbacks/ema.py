...
class EMACallback(Callback):
    ...
    def __init__(
        ...
        self.use_predefined_decay = decay is not None
        self.decay = decay
    ...
    def _get_decay(self, optimization_step):
        """
        Compute the decay factor for the exponential moving average.
        """
        if self.use_predefined_decay:
            return self.decay
    ...
    def state_dict(self) -> Dict[str, Any]:
        ...
        return {
            "shadow": self.shadow,
            "decay": self.decay,
            "use_predefined_decay": self.use_predefined_decay,
    ...
    def load_state_dict(self, state_dict: Dict[str, Any]):
        ...
        self.use_predefined_decay = state_dict.get("use_predefined_decay", self.use_predefined_decay)
